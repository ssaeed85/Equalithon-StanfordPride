...
# Next Steps
- The model can be further optimized and tuned to account for the rare issues that arises from the datasets. For example, adding weights to features that tend to be better indicators to a members identity than others. In addition there are some features that are good indicators when they hold certain values.
